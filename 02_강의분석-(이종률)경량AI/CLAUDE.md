...
| 2026-07-14 | 상단 네비(허브 "← 세미나 목록" 복귀 링크, 모드 전환) + 📖 강의 노트 모드(09_note.json → note.html, 서사형) 명세 추가 — 루트 하네스의 두 모드 공존 체계 반영 | skills/slide-interpretation, webpage-build, webpage/ | 허브 복귀 링크 + 설명(노트) 모드 공존 사용자 요청 |
